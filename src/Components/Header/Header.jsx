                ...
                <div className="navbar-end">
                    {user ? (
                        <div className="flex items-center">
                            ...
                            <a onClick={handleLogout} className="px-4 py-2 text-[14px] font-[700] cursor-pointer rounded-3xl bg-[#B8D4C6] border-none">Log Out</a>
                        </div>) : (<Link to={'/login'} className="px-4 py-2 text-[14px] font-[700] cursor-pointer rounded-3xl bg-[#B8D4C6] border-none">Log In</Link>
