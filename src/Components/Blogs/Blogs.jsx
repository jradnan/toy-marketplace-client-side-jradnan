...
const Blogs = () => {
    return (
        <div className="mx-28 mt-20">
            <h1 className="text-[18px] font-bold"> What is an access token and refresh token? How do they work and where should we store them on the client-side?</h1>
            ...
            <h1 className="text-[18px] mt-10 font-bold"> Compare SQL and NoSQL databases</h1>
            ...
            <h1 className="text-[18px] mt-10 font-bold"> What is express js? What is Nest JS ?</h1>
            ...
            <h1 className="text-[18px] mt-10 font-bold"> What is MongoDB aggregate and how does it work?</h1>
