...
const Banner = () => {
    return (
        <div className="bg-[url('https://cdn.shopify.com/s/files/1/0584/0958/2731/files/banner-2.jpg?v=1665200525')] bg-no-repeat bg-cover lg:p-[350px] md:p-[200px] lg:h-96">
            ...
            <div className="py-[30px] md:ml-[-200px] lg:ml-[-200px] flex">
